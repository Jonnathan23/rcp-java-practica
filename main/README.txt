...
a persistence unit "mainPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "main/pom.xml":
...
artifact ("main.war") is already built. You can build
